!(function (t) {
  ...
  (S.showHint = function (t, e, i) {
    ...
    S.defineExtension("showHint", function (t) {
      t = (function (t, e, i) {
      ...
      if (!(1 < e.length)) {
        ...
        t.options.hint &&
          (S.signal(this, "startCompletion", this), t.update(!0));
      }
    }),
    S.defineExtension("closeHint", function () {
      this.state.completionActive && this.state.completionActive.close();
    });
  var o =
  ...
  function i(o, t) {
    ...
    for (
      ...
      var a = l.appendChild(c.createElement("li")),
        u = n[h],
        d = "CodeMirror-hint" + (h != this.selectedHint ? "" : " " + T);
      null != u.className && (d = u.className + " " + d),
        ...
        u.render
          ? u.render(a, t, u)
          : a.appendChild(c.createTextNode(u.displayText || F(u))),
        (a.hintId = h);
    }
    var f,
      e = o.options.container || c.body,
      ...
      w =
        (e !== c.body &&
          ...
          (A = c.body.getBoundingClientRect()),
          (y = w.left - A.left - H.scrollLeft),
          (b = w.top - A.top - H.scrollTop)),
        (l.style.left = m - y + "px"),
        (l.style.top = g - b + "px"),
        r.innerWidth ||
      ...
      H =
        ...
        o.options.moveOnOverlap ? l.getBoundingClientRect() : new DOMRect()),
      e =
    ...
    0 < H.bottom - A &&
      ((C = H.bottom - H.top),
      0 < p.top - (p.bottom - H.top) - C
        ? ((l.style.top = (g = p.top - C - b) + "px"), (v = !1))
        : A < C &&
          ((l.style.height = A - 5 + "px"),
    ...
    var C,
      ...
      A = H.right - w;
    if (
      (e && (A += s.display.nativeBarWidth),
      0 < A &&
        (H.right - H.left > w &&
          ((l.style.width = w - 5 + "px"), (A -= H.right - H.left - w)),
        (l.style.left = (m = Math.max(p.left - A - y, 0)) + "px")),
      e)
    )
      for (var x = l.firstChild; x; x = x.nextSibling)
        x.style.paddingRight = s.display.nativeBarWidth + "px";
    s.addKeyMap(
      ...
      s.on(
        ...
        (this.onScroll = function () {
          var t = s.getScrollInfo(),
            ...
            i = ((f = f || s.getScrollInfo()), g + f.top - t.top),
            n = i - (r.pageYOffset || (c.documentElement || c.body).scrollTop);
          if ((v || (n += l.offsetHeight), n <= e.top || n >= e.bottom))
            return o.close();
          (l.style.top = i + "px"), (l.style.left = m + f.left - t.left + "px");
        })
      ),
      S.on(l, "dblclick", function (t) {
        t = M(l, t.target || t.srcElement);
        t && null != t.hintId && (i.changeActive(t.hintId), i.pick());
      }),
      S.on(l, "click", function (t) {
        t = M(l, t.target || t.srcElement);
        t &&
          null != t.hintId &&
      ...
      S.on(l, "mousedown", function () {
        setTimeout(function () {
          s.focus();
        }, 20);
      });
    b = this.getSelectedHintRange();
    return (
  ...
  function r(t, e, i, n) {
    t.async ? t(e, n, i) : (t = t(e, i)) && t.then ? t.then(n) : n(t);
  }
  (n.prototype = {
    close: function () {
      this.active() &&
        ...
        this.widget && this.data && S.signal(this.data, "close"),
        this.widget && this.widget.close(),
        S.signal(this.cm, "endCompletion", this.cm));
    },
    active: function () {
    ...
    pick: function (t, e) {
      ...
      this.cm.operation(function () {
        i.hint
          ? i.hint(n.cm, t, i)
          : n.cm.replaceRange(F(i), i.from || t.from, i.to || t.to, "complete"),
          S.signal(t, "pick", i),
          n.cm.scrollIntoView();
      }),
    ...
    cursorActivity: function () {
      ...
      var t,
        e = this.startPos,
        i = (this.data && (e = this.data.from), this.cm.getCursor()),
    ...
    finishUpdate: function (t, e) {
      this.data && S.signal(this.data, "update");
      e =
      ...
      this.widget && this.widget.close(),
        (this.data = t) &&
          ...
          (e && 1 == t.list.length
            ? this.pick(t, 0)
            : ((this.widget = new i(this, t)), S.signal(t, "shown")));
    },
  }),
    (i.prototype = {
      close: function () {
      ...
      scrollToActive: function () {
        var t = this.getSelectedHintRange(),
          ...
          t = this.hints.childNodes[t.to],
          i = this.hints.firstChild;
        e.offsetTop < this.hints.scrollTop
          ? (this.hints.scrollTop = e.offsetTop - i.offsetTop)
      ...
      resolve: function (t, e) {
        ...
        return c.length
          ? (((e = function (t, n, o) {
            ...
            (e.supportsSelection = !0),
            e)
          : (i = t.getHelper(t.getCursor(), "hintWords"))
          ? function (t) {
              return S.hint.fromList(t, { words: i });
            }
          : S.hint.anyword
          ? function (t, e) {
              return S.hint.anyword(t, e);
            }
          : function () {};
      },
    }),
    S.registerHelper("hint", "fromList", function (t, e) {
      for (
        var i,
          n = t.getCursor(),
          t = t.getTokenAt(n),
          o = S.Pos(n.line, t.start),
          s = n,
          c =
            (t.start < n.ch && /\w/.test(t.string.charAt(n.ch - t.start - 1))
              ? (i = t.string.substr(0, n.ch - t.start))
              : ((i = ""), (o = n)),
            []),
          r = 0;
        r < e.words.length;
      ...
      if (c.length) return { list: c, from: o, to: s };
    }),
    (S.commands.autocomplete = S.showHint);
  var c = {
    hint: S.hint.auto,
    completeSingle: !0,
    alignWithWord: !0,
  ...
  S.defineOption("hintOptions", null);
});
