        ...
        if (data.choiceColumnElement) {
          ...
          switch (choiceColumnElement.getAttribute("data-name")) {
            case "0":
              Object.assign(this.Text2Img.params.data, {
                prompt:
                  "realistic, (photorealistic:1.4),masterpiece, best quality, 1girl, solo,long hair,(black hair:0.6),hair_only",
              });
              break;
            case "1":
              Object.assign(this.Text2Img.params.data, {
                prompt:
                  "realistic, (photorealistic:1.4),masterpiece, best quality, 1girl, solo,long hair,(blue hair:0.6),hair_only",
              });
              break;
            case "2":
              Object.assign(this.Text2Img.params.data, {
                prompt:
                  "realistic, (photorealistic:1.4),masterpiece, best quality, 1girl, solo,long hair,(orange hair:0.6),hair_only",
              });
              break;
            case "3":
              Object.assign(this.Text2Img.params.data, {
                prompt:
                  "realistic, (photorealistic:1.4),masterpiece, best quality, 1girl, solo,long hair,(tan hair:0.6),hair only",
              });
              break;
            case "4":
              Object.assign(this.Text2Img.params.data, {
                prompt:
                  "realistic, (photorealistic:1.4),masterpiece, best quality, 1girl, solo,long hair,(purple hair:0.6),hair_only",
              });
              break;
            case "5":
              Object.assign(this.Text2Img.params.data, {
                prompt:
                  "realistic, (photorealistic:1.4),masterpiece, best quality, 1girl, solo,long hair,(pink hair:0.6),hair_only",
              });
              break;
          }
        }
