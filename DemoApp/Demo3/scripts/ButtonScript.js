...
let ButtonScript = new UIComponent("generate-button");
...
ButtonScript.on_rendering(() => {
  ...
  ButtonScript.click(() => {
    ...
    // console.log(StableDiffusion.Text2Img.base.data);
    // StableDiffusion.Text2Img.base.data.prompt = prompt.value;
    // StableDiffusion.Text2Img.base.data.batch_size = Number(outputNumber.value);
